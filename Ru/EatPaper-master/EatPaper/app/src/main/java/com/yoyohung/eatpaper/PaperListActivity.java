...
public class PaperListActivity extends AppCompatActivity implements
    ...
    private void initRecyclerView(){
        ...
        // init the ArrayList that will contain data
        //mPapersData = new ArrayList<>();

        // init the adapter and set it to the RecyclerView
    ...
    public void onPaperSelected(DocumentSnapshot paper) {
        //TODO: go to the details page for the selected paper
        /*
         * Intent intent = .....
         * intent.putExtra(.....)
